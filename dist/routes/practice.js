...
const practice_2 = require("../middleware/practice");
exports.practiceRouter = (0, express_1.Router)();
/**
 * @swagger
 * /practice:
 *  post:
 ...
 *
 */
exports.practiceRouter.post("/", middleware_1.verifyAccessToken, middleware_1.practiceValidator, practice_1.createPractice);
/**
 * @swagger
 * /practice/{id}:
 *  get:
 ...
 */
exports.practiceRouter.get("/:practiceId", middleware_1.verifyAccessToken, practice_1.getPracticeById);
/**
 * @swagger
 * /practice:
 *  get:
 ...
 *        description: Given access token is not valid
 */
exports.practiceRouter.get("/", middleware_1.verifyAccessToken, practice_1.getPractices);
/**
 * @swagger
 * /practice/{id}:
 *  patch:
 ...
 *        description: Practice not found
 */
exports.practiceRouter.patch("/:practiceId", middleware_1.verifyAccessToken, practice_2.practiceUpdateValidator, practice_1.updatePractice);
/**
 * @swagger
 * /practice/{id}:
 *  delete:
 ...
 *        description: Practice not found
 */
exports.practiceRouter.delete("/:practiceId", middleware_1.verifyAccessToken, practice_1.deletePractice);
